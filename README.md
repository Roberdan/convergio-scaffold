...
[![CI](https://github.com/Roberdan/convergio-scaffold/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-scaffold/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-scaffold/blob/main/LICENSE)
...
```mermaid
graph LR
    CRATE[convergio-scaffold] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-scaffold = { git = "https://github.com/Roberdan/convergio-scaffold", tag = "v0.1.0" }
```
